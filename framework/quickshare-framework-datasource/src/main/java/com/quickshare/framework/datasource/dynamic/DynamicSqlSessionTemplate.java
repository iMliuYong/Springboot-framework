...
public class DynamicSqlSessionTemplate extends SqlSessionTemplate {
    ...
    private Map<String, SqlSessionFactory> targetSqlSessionFactory;
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        ...
        SqlSessionFactory targetSqlSessionFactory = this.targetSqlSessionFactory.get(DynamicDataSourceContextHolder.getDataSourceKey());
